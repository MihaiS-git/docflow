...
public class SensitiveAccessAuditController {
    ...
    public void exportJsonl(
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"sensitive-access-export.jsonl\"");
    ...
    public void exportCsv(
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"sensitive-access-export.csv\"");
        response.setCharacterEncoding("UTF-8");
