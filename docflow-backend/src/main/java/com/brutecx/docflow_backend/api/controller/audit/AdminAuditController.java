...
public class AdminAuditController {
    ...
    public ResponseEntity<AdminAuditCursorPageDTO> query(
        ...
        return ResponseEntity.ok(
                queryService.query(from, to, correlationId, actorUserId, tenantId, cursorTimestamp, cursorId, size)
        );
    }
    ...
    public void exportJsonl(
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"admin-audit-export.jsonl\"");
    ...
    public void exportCsv(
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"admin-audit-export.csv\"");
        response.setCharacterEncoding("UTF-8");
        response.setHeader(HttpHeaders.CACHE_CONTROL, "no-store");
